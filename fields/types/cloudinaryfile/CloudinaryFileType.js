...
/*
var CLOUDINARY_FIELDS = ['public_id', 'version', 'signature', 'format', 'resource_type', 'url', 'secure_url'];
*/
...
cloudinaryfile.properName = 'CloudinaryFile';
util.inherits(cloudinaryfile, FieldType);

/**
 * Gets the folder for images in this field
 */
cloudinaryfile.prototype.getFolder = function () {
	var folder = null;
 ...
 */
cloudinaryfile.prototype.addToSchema = function (schema) {
	...
	var src = function (item, options) {
		...
		cosnole.log('format', options.format);
 ...
 */
cloudinaryfile.prototype.getData = function (item) {
	var value = item.get(this.path);
	return typeof value === 'object' ? value : {};
};

cloudinaryfile.prototype._originalGetOptions = cloudinaryfile.prototype.getOptions;

cloudinaryfile.prototype.getOptions = function () {
 ...
 */
cloudinaryfile.prototype.validateInput = function (data, callback) {
 ...
 */
cloudinaryfile.prototype.validateRequiredInput = function (item, data, callback) {
 ...
 * Deprecated
 */
cloudinaryfile.prototype.inputIsValid = function () {
	return true;
};
 ...
 */
cloudinaryfile.prototype.updateItem = function (item, data, files, callback) {
	// Process arguments
...
/**
	...
	getFilename below
*/
cloudinaryfile.prototype.retryFilename = prototypeMethods.retryFilename;

/**
	Gets a filename for uploaded files based on the adapter options
*/
cloudinaryfile.prototype.getFilename = prototypeMethods.getFilename;

cloudinaryfile.prototype.fileExists = function (filename, callback) {
	var cloudinary = require('cloudinary');
